About r-ggpmisc-feedstock
=========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/r-ggpmisc-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=3399&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-ggpmisc-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-ggpmisc` can be installed with `conda`:
...
```
mamba install r-ggpmisc
```

It is possible to list all of the versions of `r-ggpmisc` available on your platform with `conda`:
...
```
mamba search r-ggpmisc --channel conda-forge
```
...
mamba repoquery search r-ggpmisc --channel conda-forge

# List packages depending on `r-ggpmisc`:
mamba repoquery whoneeds r-ggpmisc --channel conda-forge

# List dependencies of `r-ggpmisc`:
mamba repoquery depends r-ggpmisc --channel conda-forge
```
